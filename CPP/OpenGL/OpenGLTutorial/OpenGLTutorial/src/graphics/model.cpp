...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene) {
    ...
    for (unsigned int i = 0; i < mesh->mNumVertices; i++) {
        ...
        // normal vectors (check if normals are present)
        if (mesh->mNormals) {
            ...
            vertex.normal = glm::vec3(0.0f, 0.0f, 0.0f); // or compute normal if required
        }
...
void Model::computeBoundingBox(glm::vec3& min, glm::vec3& max) {
